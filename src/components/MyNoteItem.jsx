                    ...
                    <div className="col-lg-12 col-md-12 col-sm-12">
                        <div className="our_solution_category">
                            <div className="solution_cards_box">
                                <div className="solution_card" style={{display:"table"}}>
                                    ...
                                    <div className="solu_description" style={{overflow:"auto"}}>
                                        ...
                                        <button type="button" className="read_more_btn mx-5" style={{ color: "black", cursor: "pointer" }} onClick={() => { updateNote(note); }}  >Update <i className="fa-solid fa-file-pen sm  " onClick={() => { updateNote(note) }}></i></button>
